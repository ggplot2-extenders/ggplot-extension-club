...
df |> 
  ...
  labs(title = "More than 1000 contributions have been made in discussions in almost 100 threads" |> str_wrap(40)) + 
...
df |> 
  ...
  labs(title = "Our discussions connect extenders for in-depth exchanges.") + 
  theme_grey()
...
df |> 
  ...
  geom_edge_link() + 
  geom_node_label(aes(label = name)) + 
  labs(title = "And facilitate further coordination.")
