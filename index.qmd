...
<p>Interested in joining us? Please leave your contact info [here](https://docs.google.com/forms/d/e/1FAIpQLSe3M1KwUPrmTfEGuuQp0fZ0J7dZkk_82gb310JCvdouMTa_7Q/viewform) and let us know a little about your interest in ggplot2 extension so we can be in touch!</p>
:::
...
ggplot(talks) + 
  ...
  geom_text(stat = qstat_panel(compute_panel_honeycomb), 
            lineheight = .8,
            aes(size = case_when(nchar(package) <= 17 ~ 6,
                                 nchar(package)<= 22 ~ 5,
                                 TRUE ~ 3.5) ),
            ncol = 5, 
            vjust = 0) |>
